...
Este documento explica cómo ejecutar la versión inicial de PySpark del proyecto usando Docker.

La versión Spark se agregó como una mejora técnica para preparar el pipeline hacia un escenario más escalable y cercano a nube.
